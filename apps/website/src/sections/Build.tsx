      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="site-hero overflow-hidden rounded-lg border border-white/10 px-8 py-10 sm:px-12 sm:py-12">
          ...
          <p className="mt-3 max-w-xl text-sm leading-relaxed text-slate-300 sm:text-base">
            Deploy contracts with <strong className="text-white">EVM = london</strong> (Remix Advanced settings — not
            default), verify source, and point users to the live explorer at{" "}
            <span className="font-mono text-brand-200">{site.explorerUrl}</span>.
          </p>
          <div className="mt-6 flex flex-wrap gap-3">
            <a
              href={`${site.explorerUrl}/verify`}
              target="_blank"
              rel="noreferrer"
